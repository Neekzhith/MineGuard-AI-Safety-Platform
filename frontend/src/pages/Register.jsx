...
const Register = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-8 shadow-card">
      <p className="text-xs font-semibold uppercase tracking-[0.4em] text-[var(--color-text-muted)]">Create access</p>
      <h2 className="mt-2 text-2xl font-semibold text-[var(--color-text)]">Create your MineGuard account</h2>
      <p className="text-sm text-[var(--color-text-muted)]">
        Unlock live dashboards, AI guidance, and proactive alerts for underground crews.
      </p>
